...
//! This removes the overhead of encoding/decoding message payloads. But it added some complexity to the protocol.
//!
...
//! index. It also allows readers to align with the message boundaries.
//!
